...
func kongVariables() (kong.Vars, error) {
	...
	if err := merge(result, appCreateKongVars, create.CloudVMKongVars(), create.MySQLKongVars(), create.PostgresKongVars(), create.PostgresDatabaseKongVars(), logs.KongVars()); err != nil {
